...
INSERT INTO customers (email_address,fname,lname,phone)
    VALUES ('abc@xyz.com','John','Doe','7325555555');

INSERT INTO customers (email_address,fname,lname,phone)
    VALUES ('andy@vvv.com','Andy','Knoworth','9125555555');
...
INSERT INTO proposals(customer_id, package_id, pax_0,pax_age_0, pax_1,pax_age_1)
       VALUES (1, 'BAHAMA5NIGHT@COCOCLUB','John Doe',42,'Jane Doe', 39);
INSERT INTO proposals(customer_id, package_id, pax_0,pax_age_0, pax_1,pax_age_1)
